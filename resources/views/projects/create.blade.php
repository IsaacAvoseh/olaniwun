        ...
        <div class="card-body">
            <form method="POST" action="{{ route('projects.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('project_name') is-invalid @enderror" id="project_name" name="project_name" value="{{ old('project_name') }}" required autofocus>
                    @error('project_name')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('task') is-invalid @enderror" id="task" name="task" rows="2">{{ old('task') }}</textarea>
                    @error('task')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
